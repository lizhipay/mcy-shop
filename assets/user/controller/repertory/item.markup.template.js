!function () {
    ...
    const modal = (title, assign = {}) => {
        component.popup({
            submit: '/user/repertory/item/markup/save',
            tab: [
                {
                    name: title,
                    form: [
    ...
    table = new Table("/user/repertory/item/markup/get", "#repertory-markup-table");
    table.setDeleteSelector(".del-repertory-markup", "/user/repertory/item/markup/del");
    table.setUpdate("/user/repertory/item/markup/save");
        ...
        {field: 'sync_remote_download', title: '图片本地化', type: 'switch', text: "开启|关闭", reload: true},
        {
            field: 'operation', title: '操作', type: 'button', buttons: [
                ...
                },
                {
                    ...
                    tips: '删除模版',
                    click: (event, value, row, index) => {
                        component.deleteDatabase("/user/repertory/item/markup/del", [row.id], () => {
                            table.refresh();
                        });
                    }
                }
